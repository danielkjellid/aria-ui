<template>
  <div>
    <nav class="sm:hidden">
      <nuxt-link
        to="/"
        class="hover:text-gray-600 flex items-center text-sm font-semibold leading-5 text-gray-900 transition duration-150 ease-in-out"
      >
        <svg
    ...
    <nav class="sm:flex items-center hidden text-sm font-semibold leading-5">
      ...
      >
        <template v-if="!breadcrumb.current">
          <nuxt-link
            :to="breadcrumb.href"
            class="hover:text-brand-600 text-gray-900 transition duration-150 ease-in-out"
          >
            {{ breadcrumb.text }}
          </nuxt-link>
          <svg
