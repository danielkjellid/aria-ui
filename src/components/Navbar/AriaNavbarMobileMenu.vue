    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            v-if="!authenticatedUser || !authenticatedUser.isAuthenticated"
          ...
          <div v-else class="px-4 pt-6 space-y-6 border-t border-gray-200">
            <div>
              <div class="flow-root">
                <button
                  @click="mobileUserMenuActive = !mobileUserMenuActive"
                  type="button"
                ...
                >
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      <p
                        class="text-base font-medium leading-6 text-left text-gray-800"
                      >
                        Daniel Example
                      </p>
                  ...
                  <div>
                    ...
                    <ChevronDownIcon
                      v-if="!mobileUserMenuActive"
                      class="group-hover:text-gray-600 w-6 h-6 text-gray-400"
                    />
                    <ChevronUpIcon
                      v-else
                      class="group-hover:text-gray-600 w-6 h-6 text-gray-400"
                ...
                >
                  <ul
                    v-show="mobileUserMenuActive"
                    role="list"
                    aria-labelledby="user-heading-0"
                    class="mt-6 space-y-6"
                  >
                    <li class="flex">
