<template>
  <div v-click-outside="cleanupMenus">
    ...
    <aria-navbar-mobile-menu 
      ...
      @closeMenu="mobileMenuActive = false"
    />
                      ...
                      <div class="flex" v-for="menuItem in menuItems" :key="menuItem.slug">
                        <div v-if="menuItem.activatesSubMenu" class="relative flex">
                          ...
                          <button 
                            ...
                            :class="
                              [
                                isTransparent ? 'text-white hover:text-gray-300' : 'hover:text-gray-800 text-gray-700',
                                {'border-brand-800 text-brand-800' : menuItem.active || flyoutMenuActive}
                              ]
                            "
                            aria-expanded="false"
                        ...
                        <component
                          ...
                          :class="isTransparent ? 'text-white hover:text-gray-300' : 'hover:text-gray-800 text-gray-700'"
                ...
                <div class="flex items-center justify-end flex-1">
                  <div class="lg:ml-8 flex items-center">
                    ...
                    <div class="flow-root">
                      ...
                      <div v-if="!authenticatedUser || !authenticatedUser.isAuthenticated" class="lg:flex hidden">
                        <a href="#" class="group flex items-center p-2 -m-2">
...
<script lang="ts">
import { CubeTransparentIcon, ShoppingBagIcon, MenuAlt3Icon, UserCircleIcon } from '@heroicons/vue/outline'
