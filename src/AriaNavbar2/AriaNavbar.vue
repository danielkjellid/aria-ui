<template>
  <div class="bg-white" v-click-outside="cleanupMenus">
    <!-- Mobile menu -->
                    ...
                    <div class="flex justify-center h-full space-x-8">
                      <div class="flex" v-for="menuItem in menuItems" :key="menuItem.slug">
                        <div v-if="menuItem.activatesSubMenu" class="relative flex">
                          ...
                          <button 
                            type="button" 
                            class="hover:text-gray-800 relative z-10 flex items-center pt-px -mb-px text-sm font-medium text-gray-700 transition-colors duration-200 ease-out border-b-2 border-transparent"
                            :class="{'border-brand-800 text-brand-800' : menuItem.active || flyoutMenuActive}"
                            aria-expanded="false"
                        ...
                        <component
                          ...
                          href="/"
                          v-else
                          class="hover:text-gray-800 flex items-center text-sm font-medium text-gray-700"
...
export default {
  ...
  setup(_, {}) {
    ...
    let mobileUserMenuActive = ref<boolean>(false)

    const cleanupMenus = () => {
      flyoutMenuActive.value = false
      mobileMenuActive.value = false
      mobileUserMenuActive.value = false
    }
