<template>
  ...
  <article 
    ...
    :class="width === 'full' ? 'col-span-2 image-full-container' : 'col-span-2 sm:col-span-1 image-half-container'"
  > 
    <!-- The image itself. -->
  ...
  props: {
    ...
    */
    image: {
      ...
      default: {
        applyFilter: false,
        imageXs: require('../../static/images/default_512x512.jpeg'),
        imageSm: require('../../static/images/default_640x275.jpeg'),
        imageMd: require('../../static/images/default_1024x1024.jpeg'),
        imageLg: require('../../static/images/default_1024x575.jpeg'),
        imageXl: require('../../static/images/default_1536x860.jpeg'),
        image2xl: require('../../static/images/default_2048x1150.jpeg'),
      },
